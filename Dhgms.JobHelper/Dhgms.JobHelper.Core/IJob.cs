// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IJob.cs" company="DHGMS Solutions">
...
namespace Dhgms.JobHelper.Core
{
    ...
    public interface IJob<in TApplicationSettings, TJobResult>
        where TApplicationSettings : IApplicationConfiguration
    {
        Task<TJobResult> Execute(TApplicationSettings settings);
    }
}
