// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IConfigurationLoader.cs" company="DHGMS Solutions">
...
{
    public interface IConfigurationLoader<out TApplicationSettings>
        where TApplicationSettings : IApplicationConfiguration
    {
        TApplicationSettings GetApplicationSettings();
    }
}
